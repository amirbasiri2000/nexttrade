    ...
    <div className="border border-[#ffffff80] py-4 px-5 text-[#e9e9e97a] max-h-[380px] rounded-lg">
      ...
      <div className="mb-4">
        <p>
          ...
          action between the 153.90 support and the 154.80 resistance. We got a
          spike lower tonight following the israeli retaliation against iran but
          the move was completely erased as Iran dow
        </p>
      </div>
