    ...
    <div className="w-full wrapper pt-2 lg:pt-2 bg-blue-light">
      <div className="">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center text-[14px] space-x-4">
          ...
          {/* __________________ */}
          <div className=" lg:hidden text-white border-2 rounded-lg p-1 cursor-pointer hover:scale-105">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
